...
# Superstition Dataset, CLIP Analysis and Fine-tuning Pipeline
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='data/Big Data', help='Path to dataset root')
    parser.add_argument('--model_path', type=str, default='models/clip_fold1.pt', help='Path to fine-tuned model')
